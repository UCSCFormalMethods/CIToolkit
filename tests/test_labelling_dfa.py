...
def test_labelled_dfa_string_states():
    ...
    assert labelling_dfa.label(list("1")) == "1-2_Label"
    assert labelling_dfa.label(list("2")) is None

    assert labelling_dfa.label(list("00")) is None
    assert labelling_dfa.label(list("01")) == "1-2_Label"
    assert labelling_dfa.label(list("11")) == "1-2_Label"
    assert labelling_dfa.label(list("12")) == "1-2_Label"
    assert labelling_dfa.label(list("22")) is None
    assert labelling_dfa.label(list("02")) is None

    assert labelling_dfa.label(list("011")) == "1-2_Label"
    assert labelling_dfa.label(list("112")) == "1-2_Label"
    assert labelling_dfa.label(list("012")) == "1-2_Label"
    assert labelling_dfa.label(list("111")) == "3+_Label"

    assert labelling_dfa.label(list("01112")) == "3+_Label"
    assert labelling_dfa.label(list("11111")) == "3+_Label"

    assert labelling_dfa.label(list("1111111111111111111111111111111")) == "3+_Label"
    assert labelling_dfa.label(list("0010021200001100011002020011022")) == "3+_Label"
...
def test_labelled_dfa_class_states():
    """ Creates a simple complete LabellingDfa with only State class states
    and ensures this does not raise an error.
    """
    ...
    label_map = {}
    label_map[State("1_Seen")] =  "1-2_Label"
    label_map[State("2_Seen")] =  "1-2_Label"
    label_map[State("3_Seen")] =  "3+_Label"
    label_map[State("4+_Seen")] = "3+_Label"
...
def test_labelled_dfa_mixed_states():
    """ Creates a simple complete LabellingDfa with a mix of
