...
class CI(LQCI):
    ...
    """
    def __init__(self, hard_constraint: ExactSpec, soft_constraint: ExactSpec, length_bounds: tuple[int, int], num_threads: int =1, lazy=False) -> None:
    ...
    def parameterize(self, epsilon: float, prob_bounds: tuple[float, float], num_threads: int =1):
