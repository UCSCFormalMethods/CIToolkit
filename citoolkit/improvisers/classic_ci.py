...
class ClassicCI(Improviser):
    ...
    as laid out in: https://www2.eecs.berkeley.edu/Pubs/TechRpts/2019/EECS-2019-133.pdf
    ...
    """
    def __init__(self, hard_constraint: Spec, soft_constraint: Spec, length_bounds: Tuple[int], \
                 epsilon: float, prob_bounds: Tuple[float]) -> None:
        ...
        self.eopt = max(1 - max_prob * a_size, min_prob * i_size)
