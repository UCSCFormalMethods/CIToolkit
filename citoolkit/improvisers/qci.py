...
`   :param num_threads: The number of threads to use in parameterization computation.
    ...
    """
    def __init__(self, hard_constraint: ExactSpec, cost_func: ExactCostFunc, length_bounds: tuple[int, int], num_threads:int =1, lazy=False):
    ...
    def parameterize(self, cost_bound: float, prob_bounds: tuple[float, float], num_threads: int =1):
